...
def test_quartz_titles_do_not_use_emoji_logo() -> None:
    ...
    for rel in ("quartz.config.ts", "src/brain/quartz_overrides/quartz.config.ts"):
...
def test_quartz_brand_assets_are_overlayed() -> None:
    ...
    static_dir = BRAIN_OVERRIDES / "quartz" / "static"
...
def test_page_title_renders_logo_mark() -> None:
    ...
    page_title = BRAIN_OVERRIDES / "quartz" / "components" / "PageTitle.tsx"
...
def test_footer_does_not_use_emoji_logo() -> None:
    ...
    footer = BRAIN_OVERRIDES / "quartz" / "components" / "Footer.tsx"
